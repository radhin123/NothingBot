...
let handler  = async (m, { conn, command, args, usedPrefix, DevMode }) =>  {
    ...
    let msgerror = (pickRandom(['Error', ' error', 'Nice Error', 'Salah format keknya :v', 'error bro', 'Kocak error :v', 'wtf error :v', 'Ciaaa error', 'error cuyy', 'dahlah (emot batu) error']))
    try {
